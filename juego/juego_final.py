...
pygame.display.set_caption("¡Esquiva los enemigos!")  # Establece el título de la ventana.
...
# Cargar imágenes
jugador_img = pygame.image.load("C:/Users/josue/Desktop/juego/jugador.gif")      # Carga la imagen del jugador.
jugador_img = pygame.transform.scale(jugador_img, (jugador_size, jugador_size))  # Escala la imagen del jugador.
enemigo_img = pygame.image.load("C:/Users/josue/Desktop/juego/enemigo.gif")      # Carga la imagen del enemigo.
...
while True:
    ...
    if not game_over:                                                 # Si el juego no ha terminado,
        ...
        if detectar_colision(jugador_pos, enemigo_pos):               # Si hay una colisión,
            play_sound("C:/Users/josue/Desktop/juego/impacto.wav")    # reproduce el sonido de impacto.
